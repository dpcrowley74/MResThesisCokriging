function [SubDoE, SubDoEIdx, RemDoE, RemDoEIdx] = srgtsGetMaxMin(DoE,npointstotal,npoints, ndv, niterations)
...
for c1 = 1 : niterations
    ...
    X = DoE( idx , : );
    Jnew = srgtsDOEMinDistCriterion(X,npoints); % proper even for huge designs
